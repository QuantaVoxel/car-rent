                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="footer-widget__services">
                            ...
                            <ul class="footer-widget__links-list list-unstyled">
                                <li><a href="kendaraan.php">City Car</a></li>
                                <li><a href="kendaraan.php">Family MPV</a></li>
                                <li><a href="kendaraan.php">Premium SUV</a></li>
                                <li><a href="kendaraan.php">Luxury Sedan</a></li>
                                <li><a href="kendaraan.php">Sewa Lepas Kunci</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="footer-widget__contact">
                            ...
                            <ul class="footer-widget__contact-list list-unstyled">
                                <li>
                                    ...
                                    <p>Jl. Raya Kebon Jeruk No. 24, Jakarta Barat
                                        <br> Indonesia 11530</p>
                                </li>
                                <li>
                                    <div class="icon">
                                        <span class="icon-call"></span>
                                    </div>
                                    <p><a href="tel:0215550114">(021) 555-0114</a></p>
                                </li>
                                <li>
                                    <div class="icon">
                                        <span class="icon-envelope"></span>
                                    </div>
                                    <p><a href="mailto:support@gorent.com">support@gorent.com</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-xl-12">
                    <div class="site-footer__bottom-inner">
                        <div class="site-footer__copyright">
                            <p class="site-footer__copyright-text">© 2026 GoRent. Seluruh Hak Cipta Dilindungi.</p>
                        </div>
    ...
    <div class="mobile-nav__content">
        ...
        <ul class="mobile-nav__contact list-unstyled">
            <li>
                ...
                <a href="mailto:support@gorent.com">support@gorent.com</a>
            </li>
            <li>
                <i class="fas fa-phone"></i>
                <a href="tel:021-555-0114">021 555 0114</a>
            </li>
