                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="card card-flush">
                                <div class="card-header pt-5">
                                    <div class="card-title d-flex flex-column">
                                        <span
                                            class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2"><?= $counts[$role] ?? 0 ?></span>
                                        <span
                                            class="text-gray-500 pt-1 fw-semibold fs-6 text-capitalize"><?= $role ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_datatable">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                <?php foreach ($items as $item): ?>
                                    ...
                                    <div class="modal fade" id="kt_modal_edit_item_<?= $item['id_pengguna'] ?>"
                                                    ...
                                                    <div class="modal-body py-10 px-lg-17">
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid"
                                                                name="nama_lengkap"
                                                                value="<?= htmlspecialchars($item['nama_lengkap']) ?>"
                                                                required />
                                                        </div>
                                                        <div class="fv-row mb-7">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            <label class="required fs-6 fw-semibold mb-2">No.
                                                                Telepon</label>
                                                            <input type="text" class="form-control form-control-solid"
                                                                name="no_telepon"
                                                                value="<?= htmlspecialchars($item['no_telepon']) ?>"
                                                                required />
                                                        </div>
                                                            ...
                                                            <div class="col-md-6 fv-row">
                                                                ...
                                                                <select class="form-select form-select-solid"
                                                                    ...
                                                                    <option value="nonaktif"
                                                                        <?= $item['status_akun'] === 'nonaktif' ? 'selected' : '' ?>>Nonaktif</option>
                                                                    <option value="suspend"
                                                                        <?= $item['status_akun'] === 'suspend' ? 'selected' : '' ?>>Suspend</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="fv-row mb-7">
                                                            <label class="fs-6 fw-semibold mb-2">Password (Kosongkan jika
                                    ...
                                    <div class="modal fade" id="kt_modal_delete_item_<?= $item['id_pengguna'] ?>"
                                        tabindex="-1" aria-hidden="true">
            ...
            <form class="form" action="/process/pengguna/create.php" method="POST">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="fv-row mb-7">
                        ...
                        <input type="text" class="form-control form-control-solid" name="nama_lengkap"
