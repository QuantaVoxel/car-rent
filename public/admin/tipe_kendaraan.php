                            ...
                            <tbody class="fw-semibold text-gray-600">
                                <?php foreach ($items as $item): ?>
                                    <tr>
                                        ...
                                        <td class="text-end">Rp <?= number_format($item['tarif_per_km'], 0, ',', '.') ?>
                                        </td>
                                    ...
                                    <div class="modal fade" id="kt_modal_edit_item_<?= $item['id_tipe'] ?>" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            <div class="modal-content">
                                                <form class="form" action="/process/tipe_kendaraan/update.php"
                                                    method="POST">
                                                    ...
                                                    <div class="modal-body py-10 px-lg-17">
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid"
                                                                name="nama_tipe"
                                                                value="<?= htmlspecialchars($item['nama_tipe']) ?>"
                                                                required />
                                                        </div>
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <textarea class="form-control form-control-solid"
                                                                name="deskripsi"
                                                                rows="3"><?= htmlspecialchars($item['deskripsi']) ?></textarea>
                                                        </div>
                                                        <div class="row g-9 mb-7">
                                                            <div class="col-md-6 fv-row">
                                                                ...
                                                                <input type="number" class="form-control form-control-solid"
                                                                    name="kapasitas" value="<?= $item['kapasitas'] ?>"
                                                                    required />
                                                            </div>
                                                            <div class="col-md-6 fv-row">
                                                        ...
                                                        <div class="row g-9 mb-7">
                                                            <div class="col-md-6 fv-row">
                                                                <label class="required fs-6 fw-semibold mb-2">Tarif per
                                                                    KM</label>
                                                                <input type="number" class="form-control form-control-solid"
                                                                    name="tarif_per_km" value="<?= $item['tarif_per_km'] ?>"
                                                                    required />
                                                            </div>
                                                            <div class="col-md-6 fv-row">
                                                                <label class="required fs-6 fw-semibold mb-2">Tarif
                                                                    Base</label>
                                                                <input type="number" class="form-control form-control-solid"
                                                                    name="tarif_base" value="<?= $item['tarif_base'] ?>"
                                                                    required />
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="modal fade" id="kt_modal_delete_item_<?= $item['id_tipe'] ?>" tabindex="-1"
                                        aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                <form action="/process/tipe_kendaraan/delete.php" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        Apakah Anda yakin ingin menghapus tipe kendaraan
                                                        <strong><?= htmlspecialchars($item['nama_tipe']) ?></strong>?
                                                    </div>
                                                    <div class="modal-footer flex-center">
        ...
        <div class="modal-content">
            <form class="form" action="/process/tipe_kendaraan/create.php" method="POST">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="fv-row mb-7">
                        <label class="required fs-6 fw-semibold mb-2">Nama Tipe</label>
                        <input type="text" class="form-control form-control-solid" name="nama_tipe"
                            placeholder="Contoh: Mobil, Motor" required />
                    </div>
                    <div class="fv-row mb-7">
                        <label class="fs-6 fw-semibold mb-2">Deskripsi</label>
                        <textarea class="form-control form-control-solid" name="deskripsi" rows="3"
                            placeholder="Deskripsi tipe kendaraan"></textarea>
                    </div>
                    <div class="row g-9 mb-7">
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Kapasitas</label>
                            <input type="number" class="form-control form-control-solid" name="kapasitas" value="4"
                                required />
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Status</label>
                    ...
                    <div class="row g-9 mb-7">
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="number" class="form-control form-control-solid" name="tarif_per_km"
                                placeholder="0" required />
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Tarif Base</label>
                            <input type="number" class="form-control form-control-solid" name="tarif_base"
                                placeholder="0" required />
                        </div>
                    </div>
                </div>
